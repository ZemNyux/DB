...
namespace EfScaffoldTest.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=Store;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Person__3214EC075AC0503B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PUMA__3214EC07CAAEEA24");
            ...
            entity.Property(e => e.ClimateZone)
                .HasMaxLength(50)
                .HasColumnName("Climate Zone");
            entity.Property(e => e.Elev).HasColumnName("elev");
            entity.Property(e => e.IeccAshrae)
                .HasMaxLength(50)
                .HasColumnName("IECC/ASHRAE");
            entity.Property(e => e.Lat).HasColumnType("decimal(15, 6)");
            entity.Property(e => e.Long).HasColumnType("decimal(15, 6)");
            ...
            entity.Property(e => e.StationNumber)
                .HasMaxLength(50)
                .HasColumnName("station number");
            entity.Property(e => e.StationNumber2)
                .HasMaxLength(50)
                .HasColumnName("Station Number2");
            entity.Property(e => e.TimeZone).HasColumnName("time zone");
        });
