...
class Program
{
    private const string AddCitiesUrl = "http://indexzemnyux.atwebpages.com/upload.php";
    private const string GetCitiesUrl = "http://indexzemnyux.atwebpages.com/get_cities.php";
